...
* (rpc) [#877](https://github.com/crypto-org-chain/ethermint/pull/877) fix(rpc): Skip receipt when KV indexer points to a different block; avoid nil entries in GetBlockReceipts.
