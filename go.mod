...
require (
	...
	gopkg.in/yaml.v3 v3.0.1 // indirect; indirectgenesis-file-export
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/jayt106/cosmos-sdk v0.43.0-rc2.0.20220720153131-cf1c0671de90
